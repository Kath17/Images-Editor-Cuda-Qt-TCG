...
/*------------------------------------------------- readPPM -----
|  readPPM
|  Purpose:  This function reads the input image passed through
...
/*--------------- convolvePPM --------------
 |  readPPM
 |  Purpose:  This function does the convolution of input image
*--------------------------------------*/
